...
require (
	...
	gitlab.cept.gov.in/it-2.0-common/n-api-bootstrapper v0.0.4
	gitlab.cept.gov.in/it-2.0-common/n-api-log v0.0.1
	gitlab.cept.gov.in/it-2.0-common/n-api-server v0.0.8
...
require (
	...
	gitlab.cept.gov.in/it-2.0-common/api-errors v1.0.11-0.20250923094258-7dd64d593334 // indirect
	...
	gitlab.cept.gov.in/it-2.0-common/api-metrics v0.0.1 // indirect
	...
	gitlab.cept.gov.in/it-2.0-common/n-api-errors v0.0.3 // indirect
